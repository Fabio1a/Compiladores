...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_var_declaration = 24,           /* var_declaration  */
  YYSYMBOL_type_specifier = 25,            /* type_specifier  */
  YYSYMBOL_fun_declaration = 26,           /* fun_declaration  */
  YYSYMBOL_27_1 = 27,                      /* $@1  */
  ...
  YYSYMBOL_32_2 = 32,                      /* $@2  */
  YYSYMBOL_local_declarations = 33,        /* local_declarations  */
  YYSYMBOL_statement_list = 34,            /* statement_list  */
  YYSYMBOL_statement = 35,                 /* statement  */
  YYSYMBOL_expression_stmt = 36,           /* expression_stmt  */
  YYSYMBOL_return_stmt = 37,               /* return_stmt  */
  YYSYMBOL_expression = 38,                /* expression  */
  YYSYMBOL_var_assign = 39,                /* var_assign  */
  YYSYMBOL_simple_expression = 40,         /* simple_expression  */
...
{
       0,    54,    54,    58,    59,    63,    64,    69,    72,    78,
      78,    78,    83,    83,    93,    94,    98,    99,   103,   110,
     110,   121,   122,   126,   127,   131,   132,   133,   134,   138,
     142,   143,   147,   148,   152,   158,   159,   160,   164,   165,
     166,   170,   171,   174,   175,   179,   185,   186,   190,   191
};
#endif
...
static const char *const yytname[] =
{
  ...
  "FLOAT", "VOID", "RETURN", "ASSIGN", "PLUS", "MINUS", "MULT", "DIV",
  "LBRACE", "RBRACE", "LPAREN", "RPAREN", "SEMICOLON", "COMMA", "$accept",
  "program", "declaration_list", "declaration", "var_declaration",
  "type_specifier", "fun_declaration", "$@1", "params", "param_list",
  "param", "block", "$@2", "local_declarations", "statement_list",
  "statement", "expression_stmt", "return_stmt", "expression",
  "var_assign", "simple_expression", "term", "factor", "call", "args",
  "arg_list", YY_NULLPTR
};
...
{
      31,   -24,   -24,   -24,     1,    31,   -24,   -24,     0,   -24,
     -24,   -24,     5,    25,   -24,   -24,     6,   -24,    25,   -11,
     -24,    29,    34,   -24,   -24,    31,    25,    25,    13,   -24,
      28,    28,    28,    28,    16,    33,    14,   -24,   -24,   -24,
      36,    23,   -24,     9,    34,    34,   -24,   -24,   -24,    40,
      31,   -24,    25,   -24,   -24,   -24,   -24,   -24,    31,   -24,
      52,     2,    -5,     8,   -24,   -24,   -24,   -24,   -24,   -24,
      38,   -24,    39,   -24,   -24
};
...
static const yytype_int8 yydefact[] =
{
       ...
       1,     3,     0,     0,    12,     7,    42,    43,     0,     0,
      32,    33,    37,    40,    44,    15,     0,    47,     0,     8,
       0,     0,     0,     0,     0,     0,    14,    17,    34,    49,
       0,    46,    41,    42,    35,    36,    38,    39,    18,     0,
       0,    45,     0,    19,    13,    16,    48,    22,    24,    21,
       0,     0,     0,     0,    20,    28,    27,    23,    25,    26,
       0,    31,     0,    29,    30
};
...
{
     -24,   -24,   -24,    53,     3,   -23,   -24,   -24,   -24,   -24,
      10,    -2,   -24,   -24,   -24,   -24,   -24,   -24,   -18,   -24,
     -24,    18,    19,   -24,   -24,   -24
};
...
{
       0,     4,     5,     6,     7,     8,     9,    25,    35,    36,
      37,    54,    57,    58,    61,    67,    68,    69,    19,    20,
      21,    22,    23,    24,    40,    41
};
...
{
      28,    10,    34,    12,    13,    16,    17,    29,    38,    39,
      63,    16,    17,    15,    13,    26,    53,    64,    18,    48,
      65,    14,    27,    15,    18,    27,    71,    34,    16,    17,
      42,    43,    17,    50,    56,    60,     1,     2,     3,    30,
      31,    18,    52,    70,    18,    72,    32,    33,    44,    45,
      49,    46,    47,    51,    53,    62,    73,    74,    11,    66,
      55,    59
};

static const yytype_int8 yycheck[] =
{
      18,     0,    25,     3,     9,     3,     4,    18,    26,    27,
       8,     3,     4,    18,     9,     9,    14,    15,    16,     3,
      18,    16,    16,    18,    16,    16,    18,    50,     3,     4,
      17,     3,     4,    19,    52,    58,     5,     6,     7,    10,
      11,    16,    19,    61,    16,    63,    12,    13,    30,    31,
      17,    32,    33,    17,    14,     3,    18,    18,     5,    61,
      50,    58
};
...
static const yytype_int8 yystos[] =
{
       ...
       0,    23,     3,     9,    16,    18,     3,     4,    16,    38,
      39,    40,    41,    42,    43,    27,     9,    16,    38,    18,
      10,    11,    12,    13,    25,    28,    29,    30,    38,    38,
      44,    45,    17,     3,    41,    41,    42,    42,     3,    17,
      19,    17,    19,    14,    31,    30,    38,    32,    33,    24,
      25,    34,     3,     8,    15,    18,    31,    35,    36,    37,
      38,    18,    38,    18,    18
};
...
static const yytype_int8 yyr1[] =
{
      ...
      25,    25,    27,    26,    28,    28,    29,    29,    30,    32,
      31,    33,    33,    34,    34,    35,    35,    35,    35,    36,
...
#line 69 "parser.y"
                                {
        add_symbol((yyvsp[-1].str), 0); /* 0 = Variable */
    }
...
#line 83 "parser.y"
                             {
        add_symbol((yyvsp[-1].str), 1); /* 1 = Funcion */
        increase_scope(); /* Entramos al scope de la función */
    }
#line 1199 "parser.tab.c"
    break;

  case 13: /* fun_declaration: type_specifier ID LPAREN $@1 params RPAREN block  */
#line 86 "parser.y"
                          {
...
#line 103 "parser.y"
                      {
        add_symbol((yyvsp[0].str), 0); /* Parametros cuentan como variables locales */
    }
...
#line 1225 "parser.tab.c"
  ...
  case 20: /* block: LBRACE $@2 local_declarations statement_list RBRACE  */
#line 115 "parser.y"
           {
...
#line 1239 "parser.tab.c"
  ...
  case 34: /* var_assign: ID ASSIGN expression  */
#line 152 "parser.y"
                         {
        check_variable_exists((yyvsp[-2].str)); /* VALIDACIÓN SEMÁNTICA: ¿Existe la variable? */
    }
...
#line 171 "parser.y"
         { 
        check_variable_exists((yyvsp[0].str)); /* VALIDACIÓN SEMÁNTICA */
    }
#line 1255 "parser.tab.c"
    break;

  case 45: /* call: ID LPAREN args RPAREN  */
#line 179 "parser.y"
                          {
        check_function_exists((yyvsp[-3].str)); /* VALIDACIÓN SEMÁNTICA */
    }
